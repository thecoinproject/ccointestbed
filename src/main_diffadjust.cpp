...
//ccoin 2015 team
static const int64 nFilteredBlockChange = 400000; //testing for block 400k
...
//	                    return state.DoS(100, error("HEEEEEEEEEEEEYYYYYYYYYYYYYYYY AcceptBlock() : nHeight 15120 has hash agreed to"));
//        }
	//ignore blocks below 250000 (250k) sicne we have checkpoint past this block it should be okay
        if (nHeight > 250000 && (nBits != GetNextWorkRequired(pindexPrev, this)))
