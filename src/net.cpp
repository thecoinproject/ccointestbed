...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Mineabit", "cco.pool.mineabit.com"},
    {"2 Guys Hashing Seed", "50.137.162.155"},
    {"45.56.75.125", "45.56.75.125"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ccoin is probably already running."), addrBind.ToString().c_str());
        else
